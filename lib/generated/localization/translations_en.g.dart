...
class LocaleKeys implements BaseTranslations<AppLocale, LocaleKeys> {
  ...
  String year({required num n}) => (_root.$meta.ordinalResolver ?? PluralResolvers.ordinal('en'))(
        n,
        zero: '${n} years',
        one: '${n} year',
        two: '${n} years',
...
class LocaleKeysSummaryEn {
  ...
  late final LocaleKeysSummaryFlutterExperienceEn flutterExperience =
      LocaleKeysSummaryFlutterExperienceEn.internal(_root);
...
class LocaleKeysSummaryTotalExperienceEn {
  ...
  String get content =>
      'In addition to Dart, I have experience with Kotlin, Swift, JavaScript, Python, C#, R, and more';
}
...
class LocaleKeysExperienceGreenfluxEn {
  ...
  late final LocaleKeysExperienceGreenfluxAchievementsEn achievements =
      LocaleKeysExperienceGreenfluxAchievementsEn.internal(_root);
}
...
class LocaleKeysExperienceFriflexEn {
  ...
  late final LocaleKeysExperienceFriflexAchievementsEn achievements =
      LocaleKeysExperienceFriflexAchievementsEn.internal(_root);
}
...
class LocaleKeysExperienceAgroStabEn {
  ...
  late final LocaleKeysExperienceAgroStabAchievementsEn achievements =
      LocaleKeysExperienceAgroStabAchievementsEn.internal(_root);
}
...
class LocaleKeysExperienceGreenfluxAchievementsEn {
  ...
  String get achievement4 =>
      'Created pipelines to check pull requests, build and publish applications, and scripts to simplify processes';
  ...
  String get achievement7 =>
      'Fully implemented iOS Live Activities using SwiftUI and extended it to multiple applications';
...
class LocaleKeysExperienceFriflexAchievementsEn {
  ...
  String get achievement2 =>
      'Fully created 3 custom packages, maintained 10+ packages, and configured their dependencies';
  ...
  String get achievement8 =>
      'Maintained a live streaming system consisting of mobile apps, backend, and frontend areas';
}
  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'summary.totalExperience.content':
        return 'In addition to Dart, I have experience with Kotlin, Swift, JavaScript, Python, C#, R, and more';
      case 'summary.flutterExperience.subtitle':
        return 'Flutter experience';
      ...
      case 'summary.flutterExperience.content3':
        return 'applications as well as';
      case 'summary.flutterExperience.content4':
        return 'backend';
      case 'summary.flutterExperience.content5':
        return 'structures. I specialize in complex systems and custom Flutter packages';
      ...
      case 'summary.highEducation.content1':
        return '«Programming in information and communication systems» at';
      ...
      case 'summary.openSource.content':
        return 'A package for P2P communication';
      ...
      case 'summary.googlePlay.content':
        return 'An offline chat app with support for text and file sharing';
      ...
      case 'summary.subtitle':
        return 'Super short and sweet';
      case 'petProjects.title':
        return 'Pet projects';
      case 'petProjects.subtitle':
        return 'Unique, creative, mine!';
      case 'petProjects.markdown.imageButton':
        return 'View image on GitHub';
      case 'petProjects.error.title':
        return 'Oops!';
      case 'petProjects.error.subtitle':
        return ({required Object id}) => 'Project with ID=${id} not found. Please check the ID and try again.';
      case 'year':
        return ({required num n}) => (_root.$meta.ordinalResolver ?? PluralResolvers.ordinal('en'))(
              n,
              zero: '${n} years',
              one: '${n} year',
              two: '${n} years',
      ...
      case 'pageTitle':
        return 'Kseniia | Flutter Developer';
      case 'mainImageCaption':
        return 'The image was created using graphic processing';
      case 'experience.title':
        return 'Experience';
      case 'experience.subtitle':
        return 'The boring part';
      case 'experience.cv.caption':
        return 'Read more about my experience in the CV';
      ...
      case 'experience.greenflux.location':
        return 'Amsterdam, Netherlands (Hybrid)';
      case 'experience.greenflux.duration':
        return 'February 2024 – Present';
      case 'experience.greenflux.subtitle':
        return 'Developing applications for electric vehicle charging stations';
      ...
      case 'experience.greenflux.achievements.achievement1':
        return 'Supported the full development cycle: from technical specification to publication';
      case 'experience.greenflux.achievements.achievement2':
        return 'Maintained a system of over 10 applications with a shared codebase';
      case 'experience.greenflux.achievements.achievement3':
        return 'Set up linters, formatting, and introduced a common class system for all applications';
      case 'experience.greenflux.achievements.achievement4':
        return 'Created pipelines to check pull requests, build and publish applications, and scripts to simplify processes';
      case 'experience.greenflux.achievements.achievement5':
        return 'Set up Git Flow and monitored its compliance';
      case 'experience.greenflux.achievements.achievement6':
        return 'Worked closely with Google Maps, notifications, and other complex features';
      case 'experience.greenflux.achievements.achievement7':
        return 'Fully implemented iOS Live Activities using SwiftUI and extended it to multiple applications';
      case 'experience.greenflux.achievements.achievement8':
        return 'Covered the entire codebase with tests';
      ...
      case 'experience.friflex.duration':
        return 'August 2022 – December 2023';
      case 'experience.friflex.subtitle':
        return 'Development of services for recognizing chess and draughts games';
      ...
      case 'experience.friflex.achievements.achievement2':
        return 'Fully created 3 custom packages, maintained 10+ packages, and configured their dependencies';
      case 'experience.friflex.achievements.achievement3':
        return 'Successfully integrated third-party services (MiniO, Firebase)';
      case 'experience.friflex.achievements.achievement4':
        return 'Developed administrative web dashboards with Flutter Web';
      case 'experience.friflex.achievements.achievement5':
        return 'Worked on backend development using Dart';
      case 'experience.friflex.achievements.achievement6':
        return 'Created numerous UI components and animations';
      case 'experience.friflex.achievements.achievement7':
        return 'Developed a background service to send data in chunks to cloud storage';
      case 'experience.friflex.achievements.achievement8':
        return 'Maintained a live streaming system consisting of mobile apps, backend, and frontend areas';
      ...
      case 'experience.agroStab.duration':
        return 'February 2022 – July 2022';
      case 'experience.agroStab.subtitle':
        return 'Development of administrative control panels for smart greenhouses';
      ...
      case 'experience.agroStab.achievements.achievement2':
        return 'Worked on creating user interfaces using React.js';
      case 'experience.agroStab.achievements.achievement3':
        return 'Implemented data handling using react-redux';
      case 'experience.agroStab.achievements.achievement4':
        return 'Designed component structure, layout, and connections';
      case 'experience.agroStab.achievements.achievement5':
        return 'Added interactive elements to improve UX';
      case 'experience.agroStab.achievements.achievement6':
        return 'Improved the backend structure written in Nest.js and added data processing logic';
      case 'experience.agroStab.achievements.achievement7':
        return 'Designed database architecture (PostgreSQL) and implemented updates';
      case 'experience.agroStab.achievements.achievement8':
        return 'Developed algorithms for scheduled data updates in the database using Cron';
      default:
        return null;
    }
  }
