...
class LocaleKeysHi extends LocaleKeys {
	...
	@override String get pageTitle => 'Kseniia | Flutter डेवलपर';
...
class _LocaleKeysWelcomeHi extends LocaleKeysWelcomeEn {
	...
	// Translations
	@override String get title => 'Flutter डेवलपर';
...
extension on LocaleKeysHi {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'welcome.title': return 'Flutter डेवलपर';
			...
			case 'pageTitle': return 'Kseniia | Flutter डेवलपर';
