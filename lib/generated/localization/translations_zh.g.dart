...
class LocaleKeysZh extends LocaleKeys {
	...
	@override String get pageTitle => 'Kseniia | Flutter开发者';
...
class _LocaleKeysWelcomeZh extends LocaleKeysWelcomeEn {
	...
	// Translations
	@override String get title => 'Flutter 开发者';
...
extension on LocaleKeysZh {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'welcome.title': return 'Flutter 开发者';
			...
			case 'pageTitle': return 'Kseniia | Flutter开发者';
