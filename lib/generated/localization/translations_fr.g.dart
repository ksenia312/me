...
class LocaleKeysFr extends LocaleKeys {
	...
	@override String get pageTitle => 'Kseniia | Développeuse Flutter';
...
class _LocaleKeysWelcomeFr extends LocaleKeysWelcomeEn {
	...
	// Translations
	@override String get title => 'Développeuse Flutter';
...
extension on LocaleKeysFr {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'welcome.title': return 'Développeuse Flutter';
			...
			case 'pageTitle': return 'Kseniia | Développeuse Flutter';
