...
class LocaleKeysNl extends LocaleKeys {
	...
	@override String get pageTitle => 'Kseniia | Flutter-ontwikkelaar';
...
class _LocaleKeysWelcomeNl extends LocaleKeysWelcomeEn {
	...
	// Translations
	@override String get title => 'Flutter-ontwikkelaar';
...
extension on LocaleKeysNl {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'welcome.title': return 'Flutter-ontwikkelaar';
			...
			case 'pageTitle': return 'Kseniia | Flutter-ontwikkelaar';
