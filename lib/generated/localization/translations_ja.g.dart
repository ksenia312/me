...
class LocaleKeysJa extends LocaleKeys {
	...
	@override String get pageTitle => 'Kseniia | Flutter開発者';
...
class _LocaleKeysWelcomeJa extends LocaleKeysWelcomeEn {
	...
	// Translations
	@override String get title => 'Flutter開発者';
...
extension on LocaleKeysJa {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'welcome.title': return 'Flutter開発者';
			...
			case 'pageTitle': return 'Kseniia | Flutter開発者';
